...
<div align="center">
  ...
  <img src="icons/banner.jpg" alt="logo" width="140"  height="auto" />
  <br/>
...
**[Hello-world]** is first project of Microverse setting up new concepts learned
...
- **[First project creating a new repo]**
- **[Correct set up linters]**
- **[Use correct of github flow rules]**
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/Hello-world.git
```
